...
export default class Airports extends React.Component {
    ...
    componentDidMount() {
        ReactDOM.findDOMNode(this.refs.airport).focus();
        ...
        return (
            <div className="row">
                <div className="col l12 s12">
                    <h5>Airports</h5>
                    <p>Welcome to airports database. Just type the name or airport code, select correct airport from the
                        list and click 'Get Information' to get information about it</p>
                    <form className="airports-form" action="">
                        <div className="row">
                            <div className="input-field col s12 m4">
                                <input className="validate airports" name="airport" type="text" id="airport"
                                       ref="airport" required autocomplete="off"/>
                        ...
                        <div className="row">
                            <div className="col s4">
                                <a onClick={this.getInfo} className="waves-effect waves-light btn disabled">Get
                                    Information</a>
                            </div>
                        </div>
